...
export async function getWorld(worldName) {
  return await axios
    .post(`${apiServerBaseURL}/getWorld`, {
      worldName: worldName,
    })
    .catch(function (error) {
      if (error.response) {
...
export async function createWorld(numOfWorlds) {
  ...
  return await axios
    .post(`${apiServerBaseURL}/createWorld`, {
...
export async function deleteWorld(worldName) {
  ...
  return await axios
    .post(`${apiServerBaseURL}/deleteWorld`, {
      worldName: worldName,
      rev: rev,
    })
    .catch(function (error) {
...
export async function updateJellyBeanCount(worldName, numOfJellyBeans) {
  ...
  return await axios
    .post(`${apiServerBaseURL}/updateJellyBeanCount`, {
