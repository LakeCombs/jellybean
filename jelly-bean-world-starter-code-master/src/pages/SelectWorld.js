    ...
    if (requestResponse) {
      ...
      if (requestResponse.status) {
        if (requestResponse.status == 200) {
          this.setState({
            worlds: requestResponse.data.rows,
            totalWorlds: requestResponse.data["total_rows"],
          });
        } else {
      ...
      <Container style={styles.viewContainer}>
        ...
        <Row style={styles.centerButtonRow}>
          {this.state.worlds.map((worldData, index) => (
            <Button
              ...
              onClick={() => this.showWorld(worldData.id)}
            >
        ...
        <Row>
          ...
          <Button
            style={{
              ...styles.jellyBeanButton,
              ...styles.jellyBeanButtonGreen,
            }}
            onClick={() => this.createNewWorld()}
          >
